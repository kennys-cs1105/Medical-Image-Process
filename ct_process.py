...
import scipy
import numpy as np
from utils import load_scan_mhda, save_scan_mhda, bedstriping
...
if __name__ == '__main__':
    ...
    for fileIndex, filePath in enumerate(files_list):
        ...
        if not os.path.exists(saveDir):
            os.makedirs(saveDir)
        savePath = os.path.join(saveDir, '{}.mhd'.format(fileName))
        ...
        std_scan = crop_to_standard(new_scan, scale=512)
